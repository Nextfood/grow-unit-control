...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'client_relay_x1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nextfood/grow-unit-control/ros-workspace/install/${idir}'.  Ask the maintainer 'nextfood <nextfood@todo.todo>' to fix it.")
    endif()
...
set(client_relay_x1_EXPORTED_TARGETS "")
